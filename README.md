...
layouts and even syntax highlight. If you don't want to, just use the `default` 
renderer.
...
- [`delta`](https://github.com/dandavison/delta) optional but highly recommended patchset renderer
