...
impl Logger {
    ...
    /// Logger::get_logger().init_log_file(&config); // Initialize the log file
    /// Logger::get_logger().write("This is a log message"); // Write a message to the log file
    /// ```
    #[inline]
    ...
    /// Logger::get_logger().write("This is a log message");
    /// ```
